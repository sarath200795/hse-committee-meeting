# Tutorial video harness — hse-committee-meeting

Regenerates the screen-recorded tutorial (`hse-committee-meeting.mp4`) by driving the **real app**
...
```
The video is written to `demo/out/hse-committee-meeting.mp4`.
