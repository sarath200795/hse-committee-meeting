    ...
    <div className="aurora flex min-h-screen items-center justify-center p-6 text-white">
      ...
      >
        <div className="mb-4 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-extrabold">HSE Committee</h1>
        ...
        <p className="mt-4 flex items-center gap-2 text-xs text-white/50">
          <Leaf size={14} /> Create a Firebase project, enable Email/Password Auth + Firestore, then add the keys above.
        </p>
      </motion.div>
    </div>
  )
